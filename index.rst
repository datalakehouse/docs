datalakehouse developer
===============

datalakehouse is a database-as-a-service for open source data solutions including Apache Kafka, PostgreSQL, Redis, OpenSearch, MySQL, Cassandra, M3DB and InfluxDB.
...
(Looking for the previous documentation? Visit `datalakehouse Help <https://help.datalakehouse.io>`_ or use the search above.)
...
Learn about the datalakehouse platform
...
You can use the datalakehouse platform in the way that best fits your workflow:

* Use the `web console <https://console.datalakehouse.io>`_ for a convenient and friendly web-based experience.

* The ``avn`` :doc:`command-line tool <docs/tools/cli>` brings datalakehouse features to your terminal.

* For programmatic integrations, the :doc:`datalakehouse API <docs/tools/api/index>` provides an interface you can use.

* The :doc:`docs/tools/terraform` gives orchestration features for infrastructure-as-code projects.

* The :doc:`docs/tools/kubernetes` adds orchestration of your datalakehouse services to your existing Kubernetes cluster.
