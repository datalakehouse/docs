...
Commands for managing datalakehouse for Apache Kafka Connect connectors via ``avn`` commands. 


``avn service connector available``
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''

Lists Kafka Connect connector plugins available in a given datalakehouse for Apache Kafka service.
...
Creates a new Kafka Connect connector in a given datalakehouse for Apache Kafka service.
...
::
  ...
  avn service connector create kafka-demo '{
    ...
    "connector.class": "io.datalakehouse.connect.jdbc.JdbcSourceConnector",
    "connection.url": "jdbc:postgresql://demo-pg-myinventedprojectname.datalakehousecloud.com:13039/defaultdb?sslmode=require",
...
Deletes Kafka Connect connector in a given datalakehouse for Apache Kafka service.
...
Lists Kafka Connect connectors in a given datalakehouse for Apache Kafka service.
        ...
        "connectors": [
            {
                "config": {
                    "connection.password": "verysecurepassword123",
                    "connection.url": "jdbc:postgresql://demo-test-myinventedprojectname.datalakehousecloud.com:13039/defaultdb?sslmode=require",
                    "connection.user": "avnadmin",
                    "connector.class": "io.datalakehouse.connect.jdbc.JdbcSourceConnector",
                    "mode": "bulk",
                    "name": "pg-bulk-invoices-source",
                ...
                "name": "pg-bulk-invoices-source",
                "plugin": {
                    "author": "datalakehouse",
                    "class": "io.datalakehouse.connect.jdbc.JdbcSourceConnector",
                    "docURL": "https://github.com/datalakehouse/datalakehouse-kafka-connect-jdbc/blob/master/docs/source-connector.md",
                    "title": "JDBC Source",
                    "type": "source",
                    "version": "6.6.0"
                },
...
Pauses a Kafka Connect connector in a given datalakehouse for Apache Kafka service.
...
Restarts a Kafka Connect connector in a given datalakehouse for Apache Kafka service.
...
Restarts a Kafka Connect connector task in a given datalakehouse for Apache Kafka service.
...
Resumes a Kafka Connect connector in a given datalakehouse for Apache Kafka service.
...
Retrieves the configuration information for a Connect connector plugin in a given datalakehouse for Apache Kafka service.
...
Gets a Kafka Connect connector status in a given datalakehouse for Apache Kafka service.
...
Updates a Kafka Connect connector in a given datalakehouse for Apache Kafka service.
