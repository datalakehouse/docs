...
datalakehouse for OpenSearch comes with OpenSearch Dashboards included, giving a fully-featured user interface and visualization platform for your data.
...
* There's a :doc:`list of plugins <reference/plugins>` supported by datalakehouse for OpenSearch.
