...
PGLookout
    `PGLookout <https://github.com/datalakehouse/pglookout>`_ is a PostgreSQL replication monitoring and failover daemon.

.. _Terminology PGHoard:

PGHoard
    `PGHoard <https://github.com/datalakehouse/pghoard>`_ is a PostgreSQL backup daemon and restore tooling that stores backup data in cloud object stores
